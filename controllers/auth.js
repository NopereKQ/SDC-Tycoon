...
exports.save = async (req, res, next) => {
  let data = req.body.employed;
  console.log(req.body.employed);
  db.query(`UPDATE accounts SET employed = ?`, [req.body.employed], (error, results) => {
    if(error) {
      console.log(error);
    } else {
      console.log(results);
...
exports.isLoggedIn = async (req, res, next) => {
  ...
  if( req.cookies.jwt) {
    try {
      ...
      db.query('SELECT * FROM accounts WHERE id = ?', [decoded.id], (error, result) => {
        console.log(result);
